...
describe('main > helpers > convert > nodesToJs', function () {
	...
	it('single', function () {
		testNodesToJs([], null)
		testNodesToJs([{}], null)
		testNodesToJs([{_name: 'prop', _value: 'val'}], {prop: 'val'})
		testNodesToJs([{_value: 'comment'}], ['comment'])
	})

	it('list', function () {
		testNodesToJs([
			{_name: 'prop', _value: 'value1'},
	...
	it('mixed', function () {
		testNodesToJs([
			...
			}], {prop: ['comment'], prop2: {prop3: 'value3'}})
	})
	...
	it('complex', function () {
		...
		], {prop: ['comment'], prop1: {prop2: {prop3: 'value3', prop4: 'value4'}}})
	})
